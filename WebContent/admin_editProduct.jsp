...
<html lang="en">
	...
	<body data-spy="scroll" data-target=".main-nav">
        ...
        <section>
			<form action="./ProductUpdateAction.do?id=<%=list.getId()%>&pageNum=<%=pageNum %>" method="post">
				<div class="container" style="display:flex; justify-content: center;">
					<div class="col-md-6">
						<div>
							<label>상품 사진1</label>
							<img class="img-responsive" src="./resources/photos/<%=list.getPic1()%>" width="300px"><br>
						</div>
						<div >
						 	<label>상품 사진2</label>
							<img class="img-responsive" src="./resources/photos/<%=list.getPic2()%>" width="300px">
						</div>
						<div >
							<label>상품 사진3</label>
							<img class="img-responsive" src="./resources/photos/<%=list.getPic3()%>" width="300px">
						</div>
						<div>
							<label>상품 사진4</label>
							<img class="img-responsive" src="./resources/photos/<%=list.getPic4()%>" width="300px">
						</div>
					</div>
					...
					<div class="col-sm-6" style="transform: translateX(25%);">
						...
						<div class="form-group">
							...
							<input type="text" id="region" name="region" value="<%=list.getRegion()%>">
						</div>	
						<div class="form-group">
						...
						<div class="form-group" style="text-align: center;">
							...
							<a href="./CafeListAction.do" class="btn btn-main btn-lg">목록보기</a>
							<a class="btn btn-main btn-lg" href="./ProductViewAction.do?id=<%=list.getId()%>&pageNum=<%=pageNum%>">상품 상세 보기</a>
						</div>	
					</div>
